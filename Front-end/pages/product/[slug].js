              ...
              <div className="flex">
                ...
                <div className="flex mx-2">
                  <button
                    ...
                    className="flex ml-auto text-white bg-indigo-500 border-0 mx-2 py-2 px-2 focus:outline-none hover:bg-indigo-600 rounded"
                  >
                    Add to cart
                  </button>
                  <button
...
export async function getServerSideProps(context) {
  ...
  let a = await fetch(
    "https://ecomforartisans.onrender.com/api/products?filters[slug]=" + context.query.slug,
    { headers: headers }
  );
