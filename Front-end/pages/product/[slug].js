            ...
            <section className="text-gray-600 body-font overflow-hidden">
                <div className="container px-5 py-24 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src={product.attributes.imgurl} />
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            <h2 className="text-sm title-font text-gray-500 tracking-widest">E-commerce for Artisians</h2>
                            ...
                            <div className="flex">
                                ...
                                <div className='flex mx-2'>
                                    ...
                                    <button onClick={() => { router.push('/checkout') }} className="flex ml-auto text-white bg-indigo-500 border-0 mx-2 py-2 px-2 focus:outline-none hover:bg-indigo-600 rounded">Check Out</button>
...
export async function getServerSideProps(context) {
    ...
    let a = await fetch("http://localhost:1337/api/products?filters[slug]=" + context.query.slug, { headers: headers })
