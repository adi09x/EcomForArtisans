...
export async function getServerSideProps(context) {
  ...
  let a = await fetch("https://ecomforartisans.onrender.com/api/products?filters[category]=Photography", { headers: headers })
...
export default filterPhotography